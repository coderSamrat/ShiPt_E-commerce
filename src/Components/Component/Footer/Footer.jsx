                  ...
                  <div className='w-full h-auto bg-pink-600 p-6 '>
                        <div className="max-w-[90vw] h-full mx-auto flex flex-col items-center space-y-4">
                              ...
                              <div className="font-bold text-gray-200 text-md">
                                    <p>&copy; 2024 <Link to='/z' className='hover:underline ' >ShiPt</Link> | Designed by <Link to="https://www.linkedin.com/in/samrat-mallick-coder832/" className='hover:underline ' >Samrat Mallick </Link> | All Rights Reserved</p>
                              </div>
                        </div>
                  </div>
            </div>
